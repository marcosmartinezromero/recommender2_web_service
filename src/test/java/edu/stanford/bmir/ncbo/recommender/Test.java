...
public class Test {
	...
	public static void main(String[] args) {
		...
		// String input = "lichenification, herpetiform, petechiae, atrophy, abscess, bulla, cyst, furuncle, exfoliation, powdry, phenol peel, bursitis, keratoses";
		// String input = "head, cavity of stomach, white blood cell, back pain";
		// String input = "Adjuvant chemotherapy";
