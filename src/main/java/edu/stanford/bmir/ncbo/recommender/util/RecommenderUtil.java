...
public class RecommenderUtil {
	...
	// innerloop: for (Map.Entry<String, List<AnnotationTO>> entry2 :
	// annotationsForUris
	// .entrySet()) {
	...
	// List<String> urisAlreadyCompared = new ArrayList<String>();
	//
	// for (Map.Entry<String, List<AnnotationTO>> entry :
	...
	//
	// for (Map.Entry<String, List<AnnotationTO>> entry :
	// sortedAnnotationsForUris.entrySet()) {
	// System.out.println(entry.getKey() + " -> " + entry.getValue().size());
	// }
	//
	// for (Map.Entry<String, List<AnnotationTO>> entry :
	...
	public static List<String> selectUrisForCombinedRanking(
		...
		for (Map.Entry<String, List<AnnotationTO>> entry : annotations
			...
			innerloop: for (String uri : selectedUris) {
				// System.out.println("Comparison: " + entry.getKey() + " vs " +
				// uri);
				if (entry.getKey().compareTo(uri) != 0) {
					...
					if (containedBinA) {
						// System.out.println("  " + uri + " contained in " +
						// entry.getKey());
						uriToRemove = uri;
					}
	...
	// public static Map<String, List<AnnotationTO>> sortByValueSize(Map<String,
	// List<AnnotationTO>> unsortMap) {
	...
	// });
	//
	// Map<String, List<AnnotationTO>> sortedMap = new LinkedHashMap<String,
	// List<AnnotationTO>>();
	// for (Iterator it = list.iterator(); it.hasNext();) {
	// Map.Entry entry = (Map.Entry) it.next();
	// sortedMap.put((String)entry.getKey(),
	// (List<AnnotationTO>)entry.getValue());
	// }
	// return sortedMap;
	// }
